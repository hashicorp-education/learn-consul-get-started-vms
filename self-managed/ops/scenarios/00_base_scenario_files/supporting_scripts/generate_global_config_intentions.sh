...
# _log " - Create hashicups-nginx service defaults configutation"

# tee ${OUTPUT_FOLDER}global/config-hashicups-nginx-service-defaults.hcl > /dev/null << EOF
# Kind      = "service-defaults"
# Name      = "hashicups-nginx"
# Protocol  = "http"
# EOF

# tee ${OUTPUT_FOLDER}global/config-hashicups-nginx-service-defaults.json > /dev/null << EOF
# {
#     "Kind": "service-defaults",
#     "Name": "hashicups-nginx",
#     "Protocol": "http"
